...
{
    public class RepositoryBase<TEntity> : IRepositoryBase<TEntity>, IReadOnlyRepositoryBase<TEntity>  where TEntity : class
    {
        private readonly TierheimContext _db;


        public RepositoryBase(TierheimContext db)
        {
            _db = db;
        }
